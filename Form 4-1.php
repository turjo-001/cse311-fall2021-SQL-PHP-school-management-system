...
<head>
    <title>Classes taken by a teacher</title>
</head>
<style>
    .button_position {
        margin-top: 0px;
...
<body>
    ...
    <form class="form_layout" action="Form 4-1.php" method="post">
    ...
    if (isset($_POST['Submit'])) {
        ...
        $result = "SELECT class.classId, class.period, class.classTime, class.classroomId, class.teacherId, class.subjectId
                FROM class JOIN teacher ON teacher.teacherId = class.teacherId
                 WHERE teacher.initial = '$initial' ";
        $result = mysqli_query($conn, $result);

        echo "<h1 style=\"text-align:center;text-decoration: underline;\">Information of classes taken by $initial</h1><br><br>";
